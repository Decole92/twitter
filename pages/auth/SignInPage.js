...
export default function SignInPage({ providers }) {
  return (
    <div className="flex col-span-10">
      <div>
        <img
          className=" hidden lg:inline lg:h-[750px] w-[800px] md:col-span-4"
      ...
      <div>
        ...
        {Object.values(providers).map((provider) => (
          ...
          >
            <h10></h10>
            <h5 className="font-bold">Sign up with {provider.name}</h5>
            <img
              className="h-5"
        ...
        <div className="ml-10 mt-2 flex border-2 rounded-full w-[270px] items-center space-x-2 px-[50px] p-2">
          <img
            className="h-5"
            src="https://seeklogo.com/images/A/apple-logo-E3DBF3AE34-seeklogo.com.png"
          />
          <h5 className="">Sign up with Apple</h5>
        </div>

        <div className="flex my-2 ml-10 items-center ">
          <hr className="w-1/5 "></hr>
          <p className="px-2">or</p>
          <hr className="w-1/5"></hr>
        </div>

        <h5 className="bg-twitter text-white w-[270px] text-center ml-10 rounded-full font-bold h-[40px] p-2">
          Sign up with phone or email
        </h5>

        <p className="text-sm text-[10px] w-[300px] pt-2 ml-10">
        ...
        <div className="mt-[40px] mb-4">
          <h8 className="ml-10 text-lg font-semibold">
            Aready have an account?
          </h8>
        </div>
        <h5 className="bg-white text-twitter w-[270px] text-center ml-10  mb-5 rounded-full border-2 border-gray-100 font-bold h-[40px] p-2">
          Sign in
        </h5>
      </div>
    </div>
