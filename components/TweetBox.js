...
export default function TweetBox() {
  ...
  return (
    <div className="flex space-x-2 p-5  border-b">
      <img
        onClick={() => signOut()}
        className="mt-4 w-14 h-14 rounded-full cursor-pointer"
        alt="user-photo"
      ...
      <div className="flex flex-1 items-center pl-2 ">
        <div className="flex flex-1 flex-col">
          ...
          {selectedImage && (
            <div className="-left-20   flex ">
              <XMarkIcon
                onClick={() => setSelectedImage(null)}
                className="hover:bg-black shadow-md shadow-white h-10 w-10 cursor-pointer text-white  absolute bg-red-500 left-30 font-bold rounded-full"
              />
              <img
                src={selectedImage}
                className={`h-25 w-50 pb-2 rounded-lg ${
          ...
          <div className="flex  items-center">
            <div className="flex space-x-2 flex-1 relative text-twitter">
              <PhotoIcon
                ...
                className="h-7 w-7 cursor-pointer hover:bg-blue-200 rounded-full p-1"
              />
              <input
                type="file"
                hidden
